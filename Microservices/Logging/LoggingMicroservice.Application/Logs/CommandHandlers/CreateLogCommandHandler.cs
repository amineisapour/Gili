...
//        public async System.Threading.Tasks.Task<FluentResults.Result<System.Guid>> Handle
//            (Commands.CreateLogCommand request, System.Threading.CancellationToken cancellationToken)
//        {
...
namespace LoggingMicroservice.Application.Logs.CommandHandlers
{
    public class CreateLogCommandHandler : object, GiliX.Mediator.IRequestHandler<Commands.CreateLogCommand, System.Guid>
    {
        public CreateLogCommandHandler
        ...
        public async System.Threading.Tasks.Task<FluentResults.Result<System.Guid>> Handle(Commands.CreateLogCommand request, System.Threading.CancellationToken cancellationToken)
        {
            var result =
            ...
            try
            {
                ...
                var successInsert = string.Format(Resources.Messages.Successes.SuccessInsert, nameof(Domain.Models.Log));
